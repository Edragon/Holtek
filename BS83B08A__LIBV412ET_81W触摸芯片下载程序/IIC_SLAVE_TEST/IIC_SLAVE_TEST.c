...
unsigned char i;
    if(TKS_ACTIVEF){
        ...
        _sime=1;
        _simar=IIC_ADDRESS;
        _simctl0=0b11000010;    //I2C Mode ,Enable SIM
...
void    SIM_INT(){
    ...
    if(AddrMatch){
        ...
        if(SlaveMode){
            ...
            SlaveRxMode;        //receive mode (master write)
            SlaveSendACK;       //enable transmits acknowledge
            IIC_Data[In]=_simdr;    //receive data
            /* -------------------------- */
                    ...
                    if(IIC_Data[Index]<0x10){
                        ...
                        if((IIC_Data[Index]&0b00000001)==0){
                            ...
                            #asm
                                ...
                                add a,OFFSET    _KEY_FREQ[0]
                                mov __mp1,a
                                mov a,bank  _KEY_FREQ[0]
                                mov __bp,a
